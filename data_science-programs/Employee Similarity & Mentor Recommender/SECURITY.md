# Security Policy for Employee Similarity & Mentor Recommender

## Supported Versions

This is an **educational proof‑of‑concept** machine learning project. It is not intended for production use.
...
This project is designed with recommendation system security best practices:

- **Read‑only access** – The script only reads from `employees.db`; it never modifies the database.
...
- Recommendations may be biased (content‑based only).
