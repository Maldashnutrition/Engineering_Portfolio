# Security Policy for Log Anomaly Detection
...
This project is designed with machine learning security best practices:

- **Read‑only access** – The script only reads from `logs.db`; it never modifies the database.
