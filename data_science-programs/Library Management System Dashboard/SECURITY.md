# Security Policy for Library Management System Dashboard

## Supported Versions

This is an **educational proof‑of‑concept** data analysis project. It is not intended for production use.
...
This project is designed with data analysis security best practices:

- **Read‑only access** – The script only reads from `library.db`; it never modifies the database.
