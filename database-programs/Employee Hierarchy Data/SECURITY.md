# Security Policy for Employee Hierarchy Data
...
- **Foreign key constraints** maintain referential integrity (self‑referencing).
- **CHECK constraints** validate data (salary > 0, etc.).
...
- No cycle prevention in schema (though detection queries are provided).
